const patchData = {
    en: {
        title: "Patch Notes - Balance & Combat Improvements Part",
                ...
                blocks: [
                    {
                        ...
                        changes: [
                            ...
                            { name: "Revenant’s Vengeance:", detail: "Now reduces the target’s Magic Defense by 20% for 5 seconds." }
                        ],
                    ...
                    },
                    {
                        title: "Dual Dagger",
                        icon: "fas fa-khanda",
                        intro: "While originally designed as a high sustained DPS class, Dual Crossbow (Dagger) had access to excessive crowd control and chaining potential, creating an unhealthy balance dynamic.<br><br>To address this:",
                        changes: [
    ...
    tr: {
        title: "Yama Notları - Denge ve Savaş İyileştirmeleri",
        ...
        sections: [
                ...
                blocks: [
                    {
                        ...
                        changes: [
                            ...
                            { name: "Revenant’ın İntikamı:", detail: "Artık hedefin Büyü Savunmasını 5 saniyeliğine %20 düşürüyor." }
                        ],
            ...
            },
            {
                ...
                icon: "fas fa-cogs",
                intro: "Çift Elli Kılıç, sağlam çarpışmalar ve cephe baskısı etrafında inşa edilmiş yüksek etkili bir yakın dövüş tarzını temsil eder. Yakın dövüşte etkili olsa da teçhizatının bazı yönleri aşırı derecede kısıtlayıcıydı.<br><br>Genel savaş akışını iyileştirmek adına ayarlamalar yaptık:",
                listInfo: [
